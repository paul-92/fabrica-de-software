...
## Objetivo
Orientar decisões sobre autoridade, interesse, impacto e participação de cada grupo.
...
- Separe sponsor, decisor, operador, usuário e afetado.
- registre influência e informação que cada grupo confirma.
- minimize dados pessoais no mapa.
