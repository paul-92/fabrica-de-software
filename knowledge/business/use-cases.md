...
## Objetivo
Orientar decisões sobre atores, precondições, fluxo principal, alternativas e pós-condições.
...
- Defina ator, gatilho, precondição e resultado.
- cubra fluxo principal, alternativos e exceções.
- relacione regras e requisitos não funcionais.
