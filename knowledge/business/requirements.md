...
## Objetivo
Orientar decisões sobre requisitos claros, singulares, testáveis e rastreáveis à fonte.
...
- Use um ID estável e uma única necessidade por requisito.
- ligue origem, regra, prioridade e critérios.
- trate alteração por versão e change request.
