...
## Objetivo
Orientar decisões sobre regras com fonte, vigência, exceções e precedência.
...
- Declare uma regra por ID e fonte autorizada.
- registre condições, exceções, precedência e vigência.
- não confunda política com implementação.
