...
## Objetivo
Orientar decisões sobre menor incremento coerente capaz de testar valor ou operação.
...
- Escolha o menor conjunto coerente que testa valor.
- preserve obrigações e operação essencial.
- registre explicitamente o que fica fora.
