...
## Objetivo
Orientar decisões sobre necessidade e valor, complementados por critérios verificáveis.
...
- Use story para conversa sobre valor, não como especificação completa.
- inclua critérios, regras e dependências.
- divida por resultado observável.
