...
## Objetivo
Orientar decisões sobre timeouts, retries, idempotência, degradação e recuperação.
...
- Defina orçamento de timeout por jornada.
- retry somente em falha transitória e operação segura.
- teste degradação, circuit breaker e recuperação.
