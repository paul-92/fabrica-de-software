...
## Objetivo
Orientar decisões sobre alternativas guiadas por atributos de qualidade e restrições.
...
- Derive opções dos atributos de qualidade.
- compare custo total, risco, equipe e reversibilidade.
- use PoC apenas para incerteza relevante.
