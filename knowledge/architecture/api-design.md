...
## Objetivo
Orientar decisões sobre contratos compatíveis, seguros, idempotentes e observáveis.
...
- Modele contrato pelo consumidor e pela semântica.
- defina erros, idempotência e compatibilidade.
- trate autorização, limites e depreciação.
