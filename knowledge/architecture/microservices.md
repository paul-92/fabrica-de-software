...
## Objetivo
Orientar decisões sobre serviços autônomos somente quando autonomia compensa custo distribuído.
...
- Exija autonomia de domínio e implantação como benefício.
- inclua rede, consistência, observabilidade e operação no custo.
- evite banco compartilhado sem ownership explícito.
