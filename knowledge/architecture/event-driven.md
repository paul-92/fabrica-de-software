...
## Objetivo
Orientar decisões sobre eventos com semântica, ownership, entrega e recuperação explícitos.
...
- Evento registra fato passado e produtor responsável.
- defina entrega, ordem, duplicidade e evolução de schema.
- projete replay, DLQ e recuperação sem presumir exactly-once.
