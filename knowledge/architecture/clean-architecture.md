...
## Objetivo
Orientar decisões sobre dependências orientadas ao domínio sem dogma estrutural.
...
- Mantenha regras de domínio independentes de detalhes.
- use portas onde há fronteira real de mudança.
