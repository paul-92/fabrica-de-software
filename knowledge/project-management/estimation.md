...
## Objetivo
Orientar decisões sobre faixas, incerteza, premissas e atualização por evidência.
...
- Use faixa e confiança, não precisão falsa.
- explicite escopo, premissas e dependências.
- reestime quando o aprendizado mudar a distribuição.
