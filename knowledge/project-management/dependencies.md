...
## Objetivo
Orientar decisões sobre dependências com dono, data, impacto e alternativa.
...
- Diferencie dependência técnica, decisória e externa.
- registre dono, data e impacto.
- defina alternativa ou condição de bloqueio.
