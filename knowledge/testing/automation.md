...
## Objetivo
Orientar decisões sobre automação estável, determinística, mantida e útil ao feedback.
...
- Automatize feedback repetível e valioso.
- controle dados, relógio e dependências.
- meça manutenção e tempo de diagnóstico.
