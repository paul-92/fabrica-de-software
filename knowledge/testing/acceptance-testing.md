...
## Objetivo
Orientar decisões sobre evidência observável de critérios de negócio.
...
- Transforme critérios em resultados observáveis.
- inclua regras e exceções críticas.
- obtenha aceite do responsável de produto.
