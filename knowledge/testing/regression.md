...
## Objetivo
Orientar decisões sobre seleção por impacto e histórico, com baseline confiável.
...
- Selecione por impacto da mudança e histórico.
- mantenha baseline confiável.
- investigue flakiness em vez de repetir até passar.
