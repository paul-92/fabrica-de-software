...
## Objetivo
Orientar decisões sobre feedback rápido na base e poucos testes ponta a ponta essenciais.
...
- Mantenha maior volume de testes rápidos e determinísticos.
- use integração nas fronteiras.
- reserve E2E para jornadas críticas.
