...
## Objetivo
Orientar decisões sobre identidade, sessão, recuperação e resistência a abuso.
...
- Proteja inscrição, login, sessão e recuperação.
- aplique MFA conforme risco.
- não revele existência de conta indevidamente.
