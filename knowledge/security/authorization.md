...
## Objetivo
Orientar decisões sobre deny-by-default, servidor, menor privilégio e teste de isolamento.
...
- Valide no servidor e negue por padrão.
- modele recurso, ação, sujeito e contexto.
- teste isolamento horizontal e vertical.
