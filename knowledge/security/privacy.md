...
## Objetivo
Orientar decisões sobre finalidade, minimização, base autorizada, retenção e direitos.
...
- Defina finalidade e base autorizada.
- minimize coleta, acesso e retenção.
- permita direitos, descarte e auditoria.
