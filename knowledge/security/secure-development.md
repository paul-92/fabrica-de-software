...
## Objetivo
Orientar decisões sobre ameaças e controles ao longo de todo lifecycle.
...
- Inclua segurança em discovery, design, implementação e operação.
- automatize controles repetíveis.
- bloqueie achado crítico sem mitigação.
