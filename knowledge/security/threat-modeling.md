...
## Objetivo
Orientar decisões sobre ativos, atores, trust boundaries, abuso, mitigação e risco residual.
...
- Identifique ativos, atores e trust boundaries.
- modele abuso e impacto.
- ligue mitigação, verificação e risco residual.
