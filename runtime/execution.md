...
Especificar a unidade segura de execução sem integrar modelos de IA nesta versão.
...
Timeout, cancelamento e falha parcial preservam estado; efeitos externos exigem idempotency key e autorização. Falhas emitem evento, preservam causa e não avançam o estado silenciosamente.
