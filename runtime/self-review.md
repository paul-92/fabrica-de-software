...
Tornar a revisão do próprio agente verificável sem integrar modelos de IA nesta versão.
...
Self-review não substitui revisor independente nem pode aprovar conflito de interesse. Falhas emitem evento, preservam causa e não avançam o estado silenciosamente.
