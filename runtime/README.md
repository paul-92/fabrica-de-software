...
Delimitar o executor futuro e suas fronteiras sem integrar modelos de IA nesta versão.
...
Não seleciona produto, não aprova risco e não altera contratos durante uma execução. Falhas emitem evento, preservam causa e não avançam o estado silenciosamente.
