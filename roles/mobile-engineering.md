# Papel: mobile-engineering

**Versão:** 0.1.1 | **Status:** ativo | **Dono:** departamento correspondente

## Missão
Garantir experiências móveis com responsabilidade e evidência.
## Responsabilidades
Responder por lifecycle, conectividade, permissões, dispositivos e release; manter riscos, decisões e artefatos do domínio.
## Limites
