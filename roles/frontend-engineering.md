# Papel: frontend-engineering

**Versão:** 0.1.1 | **Status:** ativo | **Dono:** departamento correspondente

## Missão
Garantir experiências web com responsabilidade e evidência.
## Responsabilidades
Responder por semântica, estados, acessibilidade, performance e integração; manter riscos, decisões e artefatos do domínio.
## Limites
