# Papel: business-analysis

**Versão:** 0.1.1 | **Status:** ativo | **Dono:** departamento correspondente

## Missão
Garantir entendimento de negócio com responsabilidade e evidência.
## Responsabilidades
Responder por stakeholders, processos, requisitos, regras e critérios; manter riscos, decisões e artefatos do domínio.
## Limites
