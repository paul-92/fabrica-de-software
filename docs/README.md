...
O ciclo determinístico de correção funcional está em
...
As projeções operacionais públicas de agentes, Quality Gates, Advanced
Knowledge Queries, Runtime Branding e o primeiro vertical Project Engineering
operacional, além da metodologia de testes e do fechamento formal, estão em
[Fase 23](phase-23/operational-projections.md).
