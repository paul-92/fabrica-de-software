...
**Dono:** documentation-engineer | **Versão:** 0.1.1 | **Status:** ativo

## Objetivo e quando usar

Atualizar informação para usuários e operação. Executar quando o lifecycle, uma condição do workflow
...
`technical-documentation`. Entrada incompatível gera `stage.blocked`, não hipótese silenciosa.

## Procedimento específico

1. Identificar públicos e tarefas.
2. Comparar comportamento com fontes.
3. Atualizar guias, referência e runbook.
4. Testar navegação, links e exemplos.
5. Produzir e versionar `technical-documentation`, ligando fontes e decisões.
6. Fazer self-review e obter revisão independente quando o risco exigir.
7. Avaliar `QG-DOC` e emitir handoff, eventos e próxima ação.
...
Saída principal: `technical-documentation` com evidências, riscos, decisões e handoff.
Gate: `QG-DOC`. Conclui quando documentação revisada pelo público responsável.
