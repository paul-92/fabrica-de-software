...
Transferir ativos e responsabilidade. Executar quando o lifecycle, uma condição do workflow
...
`handover`. Entrada incompatível gera `stage.blocked`, não hipótese silenciosa.

## Procedimento específico

1. Inventariar ativos, acessos e ownership.
2. Demonstrar operação e decisões.
3. Transferir riscos e pendências com dono.
4. Obter confirmação explícita do receptor.
5. Produzir e versionar `handover`, ligando fontes e decisões.
6. Fazer self-review e obter revisão independente quando o risco exigir.
7. Avaliar `QG-HANDOVER` e emitir handoff, eventos e próxima ação.
...
Saída principal: `handover` com evidências, riscos, decisões e handoff.
Gate: `QG-HANDOVER`. Conclui quando receptor confirma completude e ownership.
